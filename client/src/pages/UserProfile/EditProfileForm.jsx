...
const EditProflieForm = ({currentUser, setSwitch}) => {

    const dispatch = useDispatch()

    const [name, setName] = useState(currentUser?.result.name)
    const [about, setAbout] = useState(currentUser?.result.about)
    const [tags, setTags] = useState(currentUser?.result.tag)
  ...
  return (
    <div>
        ...
        <label htmlFor="name">
            ...
            <button type="button" className='user-cancle-btn' onClick={() => setSwitch(false)} >
                Cancle
            </button>
        </form>
    </div>
...
export default EditProflieForm